    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            if (ret > 0)
            {
                ...
                parametrosDelBen.Add(new System.Data.SqlClient.SqlParameter("IDCLIENTE", ret));
                ...
                if (cliente.CPFBen != null)
                {
                    ...
                    {
                        IncluirBeneficiario(cliente.CPFBen[i], cliente.NomeBen[i], ret);
                    }
                }
        ...
        internal long IncluirBeneficiario(string CPF, string Nome, long idCliente)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
        ...
        internal DML.Cliente Consultar(long Id)
        {
            ...
            List<System.Data.SqlClient.SqlParameter> parametrosBen = new List<System.Data.SqlClient.SqlParameter>();

            parametrosBen.Add(new System.Data.SqlClient.SqlParameter("Id", Id));
            DataSet dsBen = base.Consultar("FI_SP_ConsBeneficiariosCliente", parametrosBen);
             
            return AdicionarBeneficiarios(dsBen,cli.FirstOrDefault());
        }
        ...
        private DML.Cliente AdicionarBeneficiarios(DataSet ds, DML.Cliente cliente)
        {
            List<DML.Cliente> lista = new List<DML.Cliente>();
            if (ds != null && ds.Tables != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                cliente.CPFBen = new string[ds.Tables[0].Rows.Count];
                cliente.NomeBen = new string[ds.Tables[0].Rows.Count];
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    cliente.CPFBen[i] = ds.Tables[0].Rows[i].Field<string>("CPF");
                    cliente.NomeBen[i] = ds.Tables[0].Rows[i].Field<string>("NOME");
                }
            }
